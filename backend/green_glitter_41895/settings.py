"""
Django settings for green_glitter_41895 project.
...
ROOT_URLCONF = 'green_glitter_41895.urls'
...
WSGI_APPLICATION = 'green_glitter_41895.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_glitter_41895 API",
    "DESCRIPTION": "API documentation for green_glitter_41895 App",
    "VERSION": "v1",
}
